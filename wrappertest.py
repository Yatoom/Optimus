...
model_config = model_factory.generate_config(X, categorical, random_state=3)[0]
json.dumps(model_config)

model = OptimusCV(model_config, n_iter=10, population_size=100, scoring="accuracy", cv=10,
