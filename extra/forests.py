...
# The code for these classes comes from Scikit-Garden (https://github.com/scikit-garden/scikit-garden). It is included
# here because of some problems that might occur with the original package.
